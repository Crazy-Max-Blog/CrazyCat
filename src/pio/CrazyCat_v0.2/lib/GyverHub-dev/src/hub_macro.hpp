...
#define GH_PLATFORM F("ESP32-C3")
#elif CONFIG_IDF_TARGET_ESP32S2
#define GH_PLATFORM F("ESP32-S2")
#elif CONFIG_IDF_TARGET_ESP32S3
#define GH_PLATFORM F("ESP32-S3")
#elif CONFIG_IDF_TARGET_ESP32
#define GH_PLATFORM F("ESP32")
#elif defined(ESP8266)
#define GH_PLATFORM F("ESP8266")
#else
#define GH_PLATFORM F("Arduino")
#endif